    ...
    >
      ...
      <div className="flex items-center gap-0.5 ml-auto shrink-0">
        ...
        <button
          ...
          className={`w-5 h-5 flex items-center justify-center rounded hover:text-red-400 hover:bg-red-400/10 transition-all ${
            isSelected ? 'text-red-400/70' : 'text-surface-600 opacity-0 group-hover:opacity-100'
          }`}
          title="Remove track"
        >
