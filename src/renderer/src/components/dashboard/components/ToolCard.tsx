...
export function ToolCard({ onClick, accentClass, title, desc, icon, drawBg }: {
  ...
  return (
    <button
      onClick={onClick}
      className={`rounded-xl text-left group relative overflow-hidden flex flex-col h-full w-full bg-white/[0.03] border border-white/[0.06] ${c.hoverBorder} transition-all duration-300 backdrop-blur-sm hover:bg-white/[0.05]`}
    >
